...
// New types for VendorFeeController's Accountant -> Director chain
// (Section 16.2) — mirrors the expense_*/per_diem_* additions.
return new class extends Migration
{
    ...
    {
        $prior = array_values(array_diff(self::TYPES, [
            'vendor_fee_ready_for_payment', 'vendor_fee_paid', 'vendor_fee_rejected',
        ]));
        DB::statement('ALTER TABLE notifications DROP CONSTRAINT notifications_type_check');
        $list = "'" . implode("','", $prior) . "'";
