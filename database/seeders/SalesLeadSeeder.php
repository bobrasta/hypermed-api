...
class SalesLeadSeeder extends Seeder
{
    ...
    {
        // hospital_id used to be hardcoded 3/6/7, pointing at the original
        // demo hospitals RemoveDemoDataSeeder deletes in favor of the real
        // facility import — this seeder was never updated to match, so it
        // aborted after its first (hospital_name_raw-only) record.
        $hospitals = Hospital::orderBy('id')->limit(3)->pluck('id')->values();
        ...
        $leads = [
            ...
            ['hospital_id' => $hospitals[0] ?? null,   'hospital_name_raw' => null,                         'contact_name_raw' => 'Engr. Paul Njau',   'machine_type' => 'MRI',          'deal_value' => 95000000, 'stage' => 'demo_scheduled',  'demo_date' => '2026-06-15', 'assigned_to' => 5],
            ...
            ['hospital_id' => $hospitals[1] ?? null,   'hospital_name_raw' => null,                         'contact_name_raw' => 'Dr. John Masanja',  'machine_type' => 'X-Ray',       'deal_value' => 35000000, 'stage' => 'negotiation',     'assigned_to' => 5],
            ...
            ['hospital_id' => $hospitals[2] ?? null,   'hospital_name_raw' => null,                         'contact_name_raw' => 'Dr. Mwambe',        'machine_type' => 'Biochem Analyser', 'deal_value' => 22000000, 'stage' => 'won',        'assigned_to' => 5],
